...
Config::Config()
    : pdo_type(PdoType::NONE), supply_mode(SupplyMode::CV), min_voltage(5000),
      max_voltage(5000), min_current(1000), max_current(1000),
      is_menu_enabled(false), is_editing_enabled(false) {}
